...
#SBATCH --mem=24G
# Specify a job name:
#SBATCH -J qm9-64-0.0001-64-48-r18-%j
# Specify an output file
# %j is a special variable that is replaced by the JobID when
# job starts
#SBATCH -o qm9-64-0.0001-64-48-r18-%j.out
#SBATCH -e qm9-64-0.0001-64-48-r18-%j.out
...
python regression.py ../../scratch/qm9 64 0.0001 64 48 resnet18 qm9-64-0.0001-64-48-r18