...
#SBATCH --mem=24G
# Specify a job name:
#SBATCH -J qm8-64-0.0001-64-48-r18-%j
# Specify an output file
# %j is a special variable that is replaced by the JobID when
# job starts
#SBATCH -o qm8-64-0.0001-64-48-r18-%j.out
#SBATCH -e qm8-64-0.0001-64-48-r18-%j.out
...
python regression.py ../../scratch/qm8 64 0.0001 64 48 resnet18 qm8-64-0.0001-64-48-r18